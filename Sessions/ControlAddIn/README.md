# Customize Business Central UI ControlAddIn 

A small guidance for use of control addin inside the Business Central to achieve the Customization in UI Level.
We can integrate Javascript in Business Central using Control AddIn.
